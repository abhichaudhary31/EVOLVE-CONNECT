...
%>
        ...
        <tbody>
        <%
            ResultSet rs=st.executeQuery("select *from product2 inner join cart on product2.id=cart.product_id and cart.email='"+email+"' and cart.address is NULL");
            while(rs.next())
            {
...
<div class="left-div">
<h3>Mobile Number</h3>
    <input class="input-style" type="number" name="mobileNumber" value="<%=rs2.getString(3)%>" placeholder="Enter mobile " required>
