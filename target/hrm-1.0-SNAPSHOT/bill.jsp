...
<table id="customers">
  ...
  <tr>
    ...
    <%
  ResultSet rs1=st.executeQuery("select * from cart inner join  product2 where cart.product_id=product2.id and cart.email='"+email+"' and cart.status='bill' ");
while(rs1.next())
  {
  sno=sno+1;
%>
...
<a href="logout.jsp"><button class="button left-button">logot</button></a>
